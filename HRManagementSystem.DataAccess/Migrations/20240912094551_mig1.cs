    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AdvertisementAppUserStatus",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisementAppUserStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Definition = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CvPath = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisementAppUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvertisementAppUsers_AdvertisementAppUserStatus_AdvertisementAppUserStatusId",
                        column: x => x.AdvertisementAppUserStatusId,
                        principalTable: "AdvertisementAppUserStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
